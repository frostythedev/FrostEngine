...
public interface DatabaseField {
    ...
    String DATA_VARCHAR_9999 = "data VARCHAR(9999)";
    String KEY_DATA_VALUES = ID_PRIMARY_KEY + ", " + DATA_VARCHAR_9999;
    ...
    String ARENA_VALUES = ID_PRIMARY_KEY + ", minigameName VARCHAR(9999), " + DATA_VARCHAR_9999;

    String KIT_TABLE = "fe_kits";
    String KIT_VALUES = ID_PRIMARY_KEY + ", minigameName VARCHAR(9999), kitName VARCHAR(16), " + DATA_VARCHAR_9999;
