...
public class Hologram {
    ...
    public boolean show(Player player){
        if(!lines.isEmpty()){
           ...
           if(FEPlugin.get().getHologramManager().getHologram(player, name) == null){
               ...
               if(FEPlugin.get().getHologramManager().getHolograms(player) == null){
                   FEPlugin.get().getHologramManager().getPlayerHolograms().put(player.getUniqueId(), Lists.newArrayList());
               }
               FEPlugin.get().getHologramManager().getHolograms(player).add(this);
               return true;
           }else{
               try {
    ...
    public void destroy(Player player){
        ...
        FEPlugin.get().getHologramManager().getHolograms(player).remove(this);
    }
