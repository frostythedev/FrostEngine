...
public class KitManager {
    ...
    public void loadKits() {
        ...
        Database.get().syncQuery("SELECT * FROM " + DatabaseField.KIT_TABLE, null, gkCallback);
    ...
    public boolean createKit(GameKit gameKit) {
        ...
        Database.get().asyncSyncInsert("INSERT INTO " + DatabaseField.KIT_TABLE + "(name,data)" +
                " VALUES (?,?)", new Object[]{gameKit.getName(), gameKit.serialize().toString()});
        return true;
    }
