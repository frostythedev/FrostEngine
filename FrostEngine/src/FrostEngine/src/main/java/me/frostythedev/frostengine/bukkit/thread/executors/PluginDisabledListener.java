package me.frostythedev.frostengine.bukkit.thread.executors;
...
class PluginDisabledListener implements Listener {
    ...
    /**
     * Retrieve the associated disabled listeners.
     *
     * @param plugin - the plugin.
     * @return Associated listeners.
     */
    public static PluginDisabledListener getListener(final Plugin plugin) {
        ...
        if (result == null) {
            ...
            if (result == null) {
                // Register listeners - we can't use the normal method as the plugin might not be enabled yet
